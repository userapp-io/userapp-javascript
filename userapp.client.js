(function() {
    ...
    HttpRequest.prototype.create = function(method, path, body, callback) {
        ...
        if (xhr.setCredentials) {
            ...
            this.headers["Authorization"] = "Basic " + Base64.encode((this.credentials.username || "") + ':' + (this.credentials.password || ""));
        }
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        if (typeof module !== 'undefined' && module.exports) {
            exports = module.exports = UserApp;
        }
